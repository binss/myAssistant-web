...
STATICFILES_DIRS = (
    ...
    '/Users/bin/Desktop/code/web/myAssintant/static',
...
SECRET_KEY = '0r4(xqv6uexh1+ihxh4+0yxa!+^cmsy9*ko7h&3(!0&kqaih#f'
...
ROOT_URLCONF = 'myAssintant.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'myAssintant.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/Users/bin/Desktop/code/web/myAssintant/templates',
)
